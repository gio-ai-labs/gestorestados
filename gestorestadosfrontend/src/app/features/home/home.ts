  ...
  template: `
    <div class="grid min-h-[60vh] place-items-center px-6 py-16">
      <div class="max-w-md text-center">
        ...
        <h2 class="font-display text-2xl font-bold text-ink-900">Bienvenido al Gestor de Estados</h2>
        ...
        <div class="mt-7 flex items-center justify-center gap-3">
          <a routerLink="/proyectos"
             class="inline-flex items-center gap-2 rounded-xl bg-ink-900 px-4 py-2.5 text-[14px] font-semibold text-white shadow-sm transition hover:bg-ink-800">
            Ver proyectos
          ...
          <a routerLink="/usuarios"
             class="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-[14px] font-semibold text-slate-700 transition hover:bg-slate-50">
            Usuarios
          </a>
        </div>
      </div>
